...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Zoomov\Http\Middleware\TrimStrings::class,
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
        \Zoomov\Http\Middleware\TrustProxies::class,
    ];
    ...
    protected $middlewareGroups = [
        ...
        'active' => [
            \Zoomov\Http\Middleware\Authenticate::class,
            \Zoomov\Http\Middleware\RedirectIfAuthenticated::class,
        ],
    ...
    protected $routeMiddleware = [
        'auth' => \Zoomov\Http\Middleware\Authenticate::class,
