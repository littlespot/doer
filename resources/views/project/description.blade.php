...
<div class="content-margin" ng-controller="preparationCtrl" ng-init="loaded()">
    <br>
    <form id="descriptionForm" onsubmit="mySubmit()" action="/admin/projects/description" method="POST" name="descriptionForm" role="form">
        {{ csrf_field() }}
        ...
        <div>
            ...
            <span class="text-info">{{trans('project.PLACES.description')}}</span>
        </div>
