...
<html>
    <head>
        <title>Welcome to project {{$title}}</title>
    </head>
    <body style="background:#999;font-family:helvetica;line-height:1.8em;color:#293a4f;font-size:12px;height:100%">
        <div style="width:480px; display: table;vertical-align: middle;margin:auto;">
            <div style="text-align: left;padding:20px 40px;background:#fff;margin:50px auto;">
                <h3>Hello，{{$guest}}</h3>
                <P>{{$user}} declared you are engaged in project {{$title}} as {{$roles}}.</p>

                <p>If you have any objections or questions, please contact us in two weeks. We may prevent the project on line according your request.</p>
